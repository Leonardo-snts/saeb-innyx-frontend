...
const Participacao = ({ data, loading, onItemClick, onClearFilter }) => {
  if (loading) {
    return (
    ...
    datasets: [
      {
        ...
        borderWidth: 2,
        pointBackgroundColor: '#18adb6',
        pointBorderColor: '#18adb6',
        pointRadius: 4,
        pointHoverRadius: 6,
        tension: 0.1,
        fill: false,
    ...
    <div className="w-full">
      ...
      <div className="flex justify-center space-x-6 mt-4">
        <div className="flex items-center space-x-2">
          <div className="w-4 h-4 bg-[#18adb6] rounded-full"></div>
